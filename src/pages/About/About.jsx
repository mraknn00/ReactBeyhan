...
return(
  ...
  <><><><><><><><section id="breadcrumbs" className="breadcrumbs">
    ...
    <header className="bg-primary text-center py-5 mb-4">
      <div className="container">
        <h1 className="fw-light text-white">Vizyonumuz / Misyonumuz</h1>
      </div>
    </header></><div className="bg-white py-5">
      <div className="container py-5">
        <div className="row align-items-center mb-5">
          <div className="col-lg-6 order-2 order-lg-1"><i className="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
            <h2 className="font-weight-light">Vizyonumuz</h2>
            <p className="font-italic text-muted mb-4">“Dünyanın her yerindeki yol arkadaşlarımıza tam potansiyellerini gerçekleştirmelerine yardımcı olmak.''</p>
          </div>
          <div className="col-lg-5 px-5 mx-auto order-1 order-lg-2">
            <div className="fttbir"></div></div>
        </div>
        <div className="row align-items-center">
          <div className="col-lg-5 px-5 mx-auto">
            <div className="fttiki"> </div></div>

          <div className="col-lg-6"><i className="fa fa-leaf fa-2x mb-3 text-primary"></i>
            <h2 className="font-weight-light">Misyonumuz</h2>
            <p className="font-italic text-muted mb-4">“Faaliyette bulunduğumuz sektörlerde; bireye ve topluma saygılı, hukuka, ekonomik ve ahlaki ilkelere bağlı, sağlık, emniyet ve çevreye duyarlı olarak Beyhan Şirketleri müşterileri, çalışanları ve paydaşlarının beklentilerini en üst seviyede karşılamak”</p>
          </div>
        </div>
      </div>
    </div></>
    <header className="bg-primary text-center py-5 mb-4">
      <div className="container">
        <h1 className="fw-light text-white">Kadromuz</h1>
      </div>
    </header></><div className="bg-light py-5">
      <div className="container py-5" >
        ...
        <div className="row text-center">
          ...
          <div>
            <div className="bg-white rounded shadow-sm py-5 px-4"><div className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm fazli"></div>
              <h5 className="mb-0">Fazlı Beyhan</h5><span className="small text-uppercase text-muted">CEO - Founder</span>
            </div>
            <br />
          </div>
          ...
          <div className="col-sm-6 mb-5">
            <div className="bg-white rounded shadow-sm py-5 px-4"><div className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm fatih"></div>
              <h5 className="mb-0">Fatih Akbaba</h5><span className="small text-uppercase text-muted">Computer Engineer</span>
            </div>
          </div>
          ...
          <div className="col-sm-6 mb-5">
            <div className="bg-white rounded shadow-sm py-5 px-4"><div className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm cihangir"></div>
              <h5 className="mb-0">Cihangir Cengiz</h5><span className="small text-uppercase text-muted">Software Engineer</span>
            </div>
          </div>


          <div className="col-sm-6 mb-5">
            <div className="bg-white rounded shadow-sm py-5 px-4"><div className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm ramiz"></div>
                <h5 className="mb-0">Mehmet Ramiz Taş</h5><span className="small text-uppercase text-muted">Software Programmer</span>
            </div>
          </div>


          <div className="col-sm-6 mb-5">
            <div className="bg-white rounded shadow-sm py-5 px-4"><div className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm akin"></div>
              <h5 className="mb-0">Akın Toğ</h5><span className="small text-uppercase text-muted">Computer Programmer</span>
            </div>
          </div>
